...
def load_mct(filename):
    ...
    with open(filename, 'r') as dest_f:
        ...
        for data in my_data[1:]:
            ...
            mct_dict.append(mct(l_airport, l_airport, cia_arrival, cia_departure,
...
def load_mct_cirium(filename):
    ...
    for index, row in xls_file.iterrows():
        arrival_station = row.values[1]
        departure_station = row.values[2]
        ...
        mct_dict.append(mct(arrival_station, departure_station,  cia_arrival, cia_departure,
                            type_arrival, type_departure, maxconnect_time))
